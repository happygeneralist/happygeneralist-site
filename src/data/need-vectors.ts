...
export const needStates: NeedState[] = [
  {
    ...
    warning: 'Users rarely need to understand something for its own sake. GOV.UK guidance treats “understand” needs as exceptional because they are often hard to test and can hide the real thing the person needs to do, decide, access or resolve.',
